...
- 大小端转换函数
    ...
    - 数字转数字
        ...
        ![[_attachments/Untitled 103 2.png|Untitled 103 2.png]]
        
    - 字符串转数字
        
        ![[_attachments/Untitled 104 2.png|Untitled 104 2.png]]
        
        传递类似 “211.214.107.99”
        
        ![[_attachments/Untitled 105 2.png|Untitled 105 2.png]]
        
    - 数字转字符串
        
        ![[_attachments/Untitled 106 2.png|Untitled 106 2.png]]
...
- 端口（port）是干什么用的
    ...
    ![[_attachments/Untitled 107 2.png|Untitled 107 2.png]]
...
![[_attachments/Untitled 108 2.png|Untitled 108 2.png]]
...
- I/O缓冲
    ...
    ![[_attachments/Untitled 109 2.png|Untitled 109 2.png]]
...
- 半连接流程
    ...
    ![[_attachments/Untitled 110 2.png|Untitled 110 2.png]]
...
- gethostbyname：通过域名获取IP
    ...
    ![[_attachments/Untitled 111 2.png|Untitled 111 2.png]]
...
- 父进程退出会弹出下一条命令提示符，如果子进程还有输出的话就会打印在下一条命令中
    ...
    ![[_attachments/Untitled 112 2.png|Untitled 112 2.png]]
...
- 这个I/O缓冲跟内核中的缓冲是两个概念，套接字的缓冲在内核里，终端输入的行缓冲也在内核里，标准I/O的缓冲是在这个基础上再加上的一层缓冲
    ...
    ![[_attachments/Untitled 113 2.png|Untitled 113 2.png]]
...
- fdclose
    ...
    ![[_attachments/Untitled 114 2.png|Untitled 114 2.png]]
    
    ![[_attachments/Untitled 115 2.png|Untitled 115 2.png]]
...
- p305. semaphore.c例子的工作流程
    ...
    ![[_attachments/Untitled 2 6.jpeg|Untitled 2 6.jpeg]]
