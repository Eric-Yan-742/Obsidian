...
- Switch data source: Accessing data souce is a big part of back end program. You may add, update, delete, search different data with different constraint. Sometimes you may expect to use different data bases in the future, their data access procedure and query langauge are different. The dependency injection feature is pretty handy for that. I can create a data manipulation interface and implement it with different data souce. 
