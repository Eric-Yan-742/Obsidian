...
- At a high-level, similar functionality to JSPs
    ...
    ![[_attachments/Untitled 190.png|Untitled 190.png]]
...
![[_attachments/Untitled 1 49.png|Untitled 1 49.png]]
...
- Form GET method calls Servlet `doGet()` method
    ...
    ![[_attachments/Untitled 2 30.png|Untitled 2 30.png]]
    
- Read form data with Servlet
    
    ![[_attachments/Untitled 3 21.png|Untitled 3 21.png]]
    
- Example
    - student-form.html
        
        ![[_attachments/Untitled 4 17.png|Untitled 4 17.png]]
    ...
    - StudentServlet.java
        ...
        ![[_attachments/Untitled 5 15.png|Untitled 5 15.png]]
...
- Form POST method calls Servlet doPost() method
    ...
    ![[_attachments/Untitled 6 15.png|Untitled 6 15.png]]
    
- Sending Data with GET method
    
    ![[_attachments/Untitled 7 13.png|Untitled 7 13.png]]
    
- Sending Data with POST method
    
    ![[_attachments/Untitled 8 13.png|Untitled 8 13.png]]
    
    - Form data is passed in the body of HTTP request message
    - You won’t see it in the browser’s URL
    
    ![[_attachments/Untitled 9 11.png|Untitled 9 11.png]]
...
- Example
    ...
    ![[_attachments/Untitled 10 9.png|Untitled 10 9.png]]
...
- Overview
    ...
    ![[_attachments/Untitled 11 9.png|Untitled 11 9.png]]
    
- Servlet can call JSP using a request dispatcher
    
    ![[_attachments/Untitled 12 7.png|Untitled 12 7.png]]
    
- Servlet can add data to request object
    
    ![[_attachments/Untitled 13 6.png|Untitled 13 6.png]]
    
    - You can add as many attributes as you want
- JSP use JSTL to access data
    
    ![[_attachments/Untitled 14 6.png|Untitled 14 6.png]]
...
- Example
    ...
    ![[_attachments/Untitled 15 6.png|Untitled 15 6.png]]
    

## More detailed example

![[_attachments/Untitled 16 6.png|Untitled 16 6.png]]
...
![[_attachments/Untitled 17 6.png|Untitled 17 6.png]]

  

![[_attachments/Untitled 18 6.png|Untitled 18 6.png]]