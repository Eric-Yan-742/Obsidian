...
When the robot starts to backtrack, it needs to `move()` back to the previous cell and maintain the original position. We achieve this by backtracking. 
