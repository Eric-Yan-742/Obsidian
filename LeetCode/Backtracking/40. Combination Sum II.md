...
- Remove same values in the same level. Don’t remove same values in the same branch
	...
	3. Duplicates in different branches and different levels will not explore the same combinations. By keeping each level with distinct numbers, nodes in different levels must be exploring different combinations. 
