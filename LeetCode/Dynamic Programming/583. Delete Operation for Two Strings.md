...
2. Recurrence Relation
	...
	3. Why we don't need to consider the case of deleting 2 chars from both strings? With our traversal order, `dp[i - 1][j - 1]` have been considered by `dp[i - 1][j]` and `dp[i][j - 1]`. 
