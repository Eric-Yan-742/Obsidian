...
Implicit Definition: Start from `nums1[-1]` and `nums2[-1]`. We can think about it like haven't considered any elements in both arrays yet. No matter this follows the definition or not, we can see that it correctly computes `num1[0]` and `nums2[0]` 
