- DCL: 控制哪些用户可以访问，管理哪些用户可以访问哪些数据库
    ...
    - 权限控制
        ...
        ![[_attachments/Untitled 22 5.png|Untitled 22 5.png]]
        
        ![[_attachments/Untitled 23 5.png|Untitled 23 5.png]]
...
- 字符串函数
    ...
    ![[_attachments/Untitled 24 5.png|Untitled 24 5.png]]
...
- 数值函数
    ...
    ![[_attachments/Untitled 25 3.png|Untitled 25 3.png]]
...
- 日期函数
    ...
    ![[_attachments/Untitled 26 3.png|Untitled 26 3.png]]
...
- 流程函数
    ...
    ![[_attachments/Untitled 27 3.png|Untitled 27 3.png]]
    ...
    [[/case when then else end（值）|case when then else end（值）]]
...
![[_attachments/Untitled 28 3.png|Untitled 28 3.png]]
...
- 外键约束：用来让两张表之间建立连接
    ...
    - 添加外键
        ...
        ![[_attachments/Untitled 29 3.png|Untitled 29 3.png]]
        
    - 删除外键
        
        ![[_attachments/Untitled 30 3.png|Untitled 30 3.png]]
        
    - 删除/更新行为
        
        ![[_attachments/Untitled 31 3.png|Untitled 31 3.png]]
